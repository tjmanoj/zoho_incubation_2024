...
class Equation {
    ...
    public Equation multiply(String equationString) {
        Equation secondEquation = Equation.parseEquation(equationString);
...
public class Main {
    public static void main(String[] args) {
        Equation equation = Equation.parseEquation("2x+y");
        
        // Equation result = equation.multiply("2x-3y");

        // double eq = equation.evaluate(new double[]{2, 1,1}); // Example values for x and y
